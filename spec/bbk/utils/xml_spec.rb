...
RSpec.describe BBK::Utils::Xml do
  ...
  describe '#normalize_slug' do
    it 'kinnalru example' do
      ...
      expect(described_class.normalize_slug(name,
                                            href)).to eq 'output_urn-x-artifacts-mcx-ru-ais-subsidii-rs-rpz-1-0-0'
    end
    ...
    it 'smev3 get request example' do
      ...
      expect(described_class.normalize_slug(name,
                                            href)).to eq 'DataRequest_urn-x-artefacts-smev-gov-ru-services-message-exchange-types-1-2'
    end
    ...
    it 'transliterate russian' do
      ...
      href = 'urn://x-artefacts-smev-gov-ru/services/message-exchange/types/1.2'
      expect(described_class.normalize_slug(name,
                                            href)).to eq 'Zapros_urn-x-artefacts-smev-gov-ru-services-message-exchange-types-1-2'
    end
  end
